...
{
    public sealed class StandardAnalyzer : ITokenizer
    {
        private static readonly ObjectPool<Lucene.Net.Analysis.Standard.StandardAnalyzer> AnalyzerPool = new(() => new(LuceneVersion.LUCENE_48));
