...
namespace Snowball
{
    ...
    internal partial class EsperantoStemmer : Stemmer
    {
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref="EsperantoStemmer"/> class.
        /// </summary>
        ///
        public EsperantoStemmer()
        {
            ...
            a_9 = new[]
            {
                ...
                new Among("e", -1, -1),
                new Among("i", -1, -1),
                new Among("j", -1, -1, r_not_after_letter),
                new Among("aj", 3, -1),
                new Among("oj", 3, -1),
                new Among("n", -1, -1, r_not_after_letter),
                new Among("an", 6, -1),
                new Among("en", 6, -1),
                new Among("jn", 6, -1, r_not_after_letter),
                new Among("ajn", 9, -1),
                new Among("ojn", 9, -1),
                new Among("on", 6, -1),
                new Among("o", -1, -1),
        ...
        private bool r_not_after_letter()
        {
            {
                int c1 = limit - cursor;
                if (!(eq_s_b("-")))
